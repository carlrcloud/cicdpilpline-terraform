...
#this in for the code pipeline


# create the role for codepipeline
...
# define the policy to attach to the codepipeline
...
# here create the actual policy base on the data source "aws_policy_document"
...
# attaching the policy to the role to be assume by codepipeline
